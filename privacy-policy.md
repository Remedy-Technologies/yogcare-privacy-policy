...
### Introduction  
Our privacy policy will help you understand what information we collect at Yogcare, how Yogcare uses it, and what choices you have.
Team Remedy built the Yogcare app as a free app. This SERVICE is provided by Team Remedy at no cost and is intended for use as is.
...
As of now we do not collect any loaction information. However, after a later update, some of the services may use location information transmitted from users' mobile phones. We shall only use this information within the scope necessary for the designated service.  

### Device Information  
As of now we do not collect information from your device. However, after a later update, we may collect information which will be utilized for the provision of better service and to prevent fraudulent acts. Additionally, such information will not include that which will identify the individual user.  

### Service Providers  
We may later employ third-party companies and individuals due to the following reasons:  
